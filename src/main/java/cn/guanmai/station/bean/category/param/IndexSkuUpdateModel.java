...
/**
 * @author: liming
 * @Date: 2020年6月23日 下午4:48:27
 * @description:
 * @version: 1.0
 */

public class IndexSkuUpdateModel {
	...
	@ExcelProperty(index = 13, value = "是否称重(可修改，1称重，0不称)")
	private int is_weigh;

	@ExcelProperty(index = 14, value = "销售状态(可修改，1上架，0下架)")
	private int state;
	...
	@ExcelProperty(index = 17, value = "报价单ID")
	private String salemenu_id;

	@ExcelProperty(index = 18, value = "报价单名称")
	private String salemenu_name;

	@ExcelProperty(index = 19, value = "参考价")
	private double reference_price;

	@ExcelProperty(index = 20, value = "排序")
	private Integer sort;

	@ExcelProperty(index = 21, value = "自定义编码")
	private String outer_id;

	@ExcelProperty(index = 22, value = "采购规格ID")
	private String spec_purchase_id;

	@ExcelProperty(index = 23, value = "装箱类型(可修改，0散件装箱，1整件装箱)")
	...
	public String getSpec_purchase_id() {
		return spec_purchase_id;
	}

	public void setSpec_purchase_id(String spec_purchase_id) {
		this.spec_purchase_id = spec_purchase_id;
	}
