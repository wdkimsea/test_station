...
public class AsyncTaskResultBean {
	...
	public AsyncTaskResultBean(int status, Integer progress, int type, Resutl result, BigDecimal task_id,
			String task_name, String user_task_id) {
		super();
		this.status = status;
		this.progress = progress;
		this.type = type;
